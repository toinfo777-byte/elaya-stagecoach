...
from app.routers.deeplink import router as deeplink_router   # NEW
from app.routers.smoke import router as smoke_router         # NEW
...
async def setup_commands(bot: Bot) -> None:
    user_cmds = [
        ...
        BotCommand(command="progress", description="Мой прогресс"),  # NEW
